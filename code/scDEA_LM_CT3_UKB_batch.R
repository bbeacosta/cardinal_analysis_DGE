...
# Save
pdf("/home/rstudio-server/results_DGE_csv_annotated/heatmap_deg_proportion_all.pdf", width=40, height=15)
pheatmap(
...
# Save
pdf("/home/rstudio-server/results_DGE_csv_annotated/heatmap_deg_proportion_diseasesOnly.pdf", width=40, height=15)
pheatmap(
...
# Save
pdf("/home/rstudio-server/results_DGE_csv_annotated/heatmap_deg_absNumber_all.pdf", width=40, height=15)
pheatmap(
...
# Save
pdf("/home/rstudio-server/results_DGE_csv_annotated/heatmap_deg_absNumber_diseasesOnly.pdf", width=40, height=15)
pheatmap(
